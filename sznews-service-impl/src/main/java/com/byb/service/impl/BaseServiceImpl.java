...
import com.byb.framework.utils.jdbc.SpecUtils;
...
public class BaseServiceImpl<M extends BaseMapper<T>, T> implements BaseService<T> {
    ...
    @Override
    public IPage<T> pageForm(Page<T> page) {
        Wrapper<T> qw = SpecUtils.condition(page);
        SpecUtils.pageable(page);
        if (qw == null) {
