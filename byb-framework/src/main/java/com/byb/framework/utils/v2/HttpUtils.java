package com.byb.framework.utils.v2;

import com.byb.framework.exception.ApplicationException;
import com.byb.framework.exception.ErrorResponseMsgEnum;
...
public class HttpUtils {
    ...
    public ResponseWrap execute(RequestWrap request) {
        ...
        try {
            ...
            return new ResponseWrap(httpClient, request.getRequest(), response, context, objMapper, xmlMapper);
        } catch (Exception e) {
            logger.error(e.getMessage(), e);
            throw new ApplicationException(ErrorResponseMsgEnum.CONNECTION_TIMEOUT);
        } finally {
    ...
    public static void main(String[] args) throws NoSuchFieldException, IllegalAccessException {
        ...
        // headers定义
        Map<String, String> headers = new HashMap<>(2 << 4);
        //querys 定义
        Map<String, String> querys = new HashMap<>(2 << 4);
        querys.put("id_number", "370404199006301915");
        querys.put("account_mobile", "13333333333");
        querys.put("account_name", "皮晴晴");
        RequestWrap requestWrap = instance.get(
                "http://localhost:9999/api/orgCompanyListByCompanyName?companyName=%E6%B7%B1%E5%9C%B3%E5%B8%82%E8%85%BE%E8%AE%AF%E8%AE%A1%E7%AE%97%E6%9C%BA%E7%B3%BB%E7%BB%9F%E6%9C%89%E9%99%90%E5%85%AC%E5%8F%B8");
//                .addParameters(querys);
