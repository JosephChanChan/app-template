...
<head>
    ...
    <!-- iCheck -->
    <link href="${ctx }/statics/css/green.css" rel="stylesheet">
    <!-- bootstrap-progressbar -->
    <link href="${ctx }/statics/css/bootstrap-progressbar-3.3.4.min.css" rel="stylesheet">
    <!-- JQVMap -->
    <link href="${ctx }/statics/css/jqvmap.min.css" rel="stylesheet"/>
    <link href="${ctx }/statics/css/dropzone.min.css" rel="stylesheet">
    <!-- Custom Theme Style -->
    <link href="${ctx }/statics/css/custom.min.css" rel="stylesheet">

    <!-- add localcss 2016-8-18 -->
    <link href='${ctx }/statics/localcss/appinfoadd.css' rel='stylesheet'>
    <link href='${ctx }/statics/localcss/appinfolist.css' rel='stylesheet'>
        ...
        <div class="col-md-3 left_col menu_fixed">
            <div class="left_col scroll-view">
                <div class="navbar nav_title" style="border: 0;">
                    <a href="${ctx}/devuser/devindex.html" class="site_title"><i class="fa fa-paw"></i><span>App信息
								管理系统</span>
                    </a>
                </div>
                ...
                <div class="profile">
                    <div class="profile_pic">
                        <img
                                src="${ctx }/statics/images/img.jpg"
                ...
                <div id="sidebar-menu"
                    ...
                    <div class="menu_section">
                        ...
                        <ul class="nav side-menu">
                            ...
                            <li>
                                <a><i class="fa fa-edit"></i> APP应用管理<span
                                        class="fa fa-chevron-down"></span>
                                </a>
                                <ul class="nav child_menu">
                ...
                <div class="sidebar-footer hidden-small">
                    ...
                    <span class="glyphicon glyphicon-fullscreen" aria-hidden="true"></span>
                        ...
                        href="${ctx}/devuser/logout.html"> <span
