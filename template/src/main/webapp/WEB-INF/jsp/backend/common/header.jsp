        ...
        <div class="col-md-3 left_col menu_fixed">
          <div class="left_col scroll-view">
            <div class="navbar nav_title" style="border: 0;">
              <a href="${ctx}/backenduser/main.html" class="site_title"><i class="fa fa-paw"></i> <span>APP BMS</span></a>
            </div>
            ...
            <div class="profile">
              <div class="profile_pic">
                <img src="${ctx}/statics/images/img.jpg" alt="..." class="img-circle profile_img">
              </div>
                ...
                <ul class="nav side-menu">
                  <li><a><i class="fa fa-home"></i> APP管理 <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      <li><a href="${ctx}/backenduser/applist.html">APP审核</a></li>
            ...
            <div class="sidebar-footer hidden-small">
              ...
              <a data-toggle="tooltip" data-placement="top" title="Logout" href="${ctx}/backenduser/logout.html">
              ...
              <ul class="nav navbar-nav navbar-right">
                <li class="">
                  <a href="javascript:;" class="user-profile dropdown-toggle" data-toggle="dropdown" aria-expanded="false">
                    <img src="${ctx}/statics/images/img.jpg" alt="">${userSession.userCode }
                    <span class=" fa fa-angle-down"></span>
                  </a>
                  <ul class="dropdown-menu dropdown-usermenu pull-right">
                    <li><a href="${ctx}/backenduser/logout.html"><i class="fa fa-sign-out pull-right"></i> Log Out</a></li>
                  </ul>
                </li>
                ...
                <li role="presentation" class="dropdown">
                  ...
                  <ul id="menu1" class="dropdown-menu list-unstyled msg_list" role="menu">
                    <li>
                      <a>
                        <span class="image"><img src="${ctx }/statics/images/img.jpg" alt="Profile Image" /></span>
                        <span>
