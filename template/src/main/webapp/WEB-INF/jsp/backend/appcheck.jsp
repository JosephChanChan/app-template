          ...
          <div class="item form-group">
           ...
           <div class="item form-group">
        	...
        	<div class="form-group">
        		...
        		<button id="status" type="button" name="status" value="2" class="btn btn-success sh">审核通过</button>
        		<button id="status1" type="button" name="status" value="3" class="btn btn-success sh">审核不通过</button>
        ...
        <script type="text/javascript">
          ...
          $(".sh").on("click",function () {
              ...
              if(val==2){
                  ...
                  flag=confirm("确认审核不通过");
              }
              if(flag){
                  $.ajax({
                      url:"${ctx}/backenduser/check.do",
                      type:"get",
                      ...
                      success:function (data) {
                          if(data.result=="true"){
                               alert("审核成功！")
                               $(location).attr("href","${ctx}/backenduser/applist.html");
                          }else {
                              alert("审核不成功！")
                          }
                      },
           ...
           <div class="item form-group">
            ...
            <c:choose> 
			  ...
			  <c:otherwise>   
			    ...
			    <a href="${ctx}/appinfo/download?filename=${appVersion.apkFileName}" >下载</a>
			    </p>
			  </c:otherwise> 
            </c:choose> 
            </div>
