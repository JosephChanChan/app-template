...
public class MD5Encoder {
	 ...
	 * @return
	 */
	public static String encodePasswordDiscuz(String rawPass, String salt) {
		String md5Pwd=encodePassword(rawPass) + salt;
		String encPwd=encodePassword(md5Pwd);
		return encPwd;
	}
	 ...
	 * @return true:密码正确；false:密码错误
	 */
	public static boolean isPasswordValidDiscuz(String encPass, String rawPass,
			String salt) {
		if (encPass == null) {
			return false;
		}
		String pass2 = encodePasswordDiscuz(rawPass, salt);
		return encPass.equals(pass2);
	}
	 ...
	 * @param salt
	 */
	public void setDefaultSalt(String salt) {
		defaultSalt = salt;
	}
}
